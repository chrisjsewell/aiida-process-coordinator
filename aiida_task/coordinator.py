...
@click.option(
    "--socket-fd",
    type=int,
    help="the file descriptor of the socket generated by circus",
)
...
def start_coordinator(
    ...
    asyncio.run(main(network_uuid, socket_fd, circus_endpoint, db_path, log_level))
...
async def coordinate_processes(
    circus_endpoint: str, db_path: str, workers: Dict[int, WorkerConnection]
):
